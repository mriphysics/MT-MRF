...
scan_type = 'in_vivo'; %%% Load reconstruction dictionary. %%%

%% Generate parameter combinations.

switch scan_type
    % These values are modified for the different fitting scenarios.
    case 'in_vivo'
        n_increments = 100;
    ...
    case 'phantom'
        ...
        T1s = 1;
        T1d = linspace(0,30e-3,n_increments);
        T2f = 84e-3;
        T2s = 8.28e-6;
        k = 55.2;
        B0_var = 0;
